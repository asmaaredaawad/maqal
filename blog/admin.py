...
class ArticleAdmin(admin.ModelAdmin):
	...
	list_display =['article_author','article_subject','article_published','article_views','article_comments','article_date','article_last_updated']
...
admin.site.register(Banned_word)
